...
void CntrApresentacaoConta::executar(Email *email)
{
    ...
    string texto5 = "4 - Consultar minhas hospedagens.";
    ...
    while (apresentar)
    {
        ...
        case 2:
            excluir(email); // implementar
            break;

        case 3:
            editar(email); // implementar
            break;

        case 4:
            apresentar = false; // implementar
            break;
        case 5:
            apresentar = false; // implementar
            break;
...
void CntrApresentacaoConta::excluir(Email *email)
{
    ...
    {
    case 1:
        servicoConta->excluirConta(email);
        break;
    case 2:
        apresentar = false;
        break;
